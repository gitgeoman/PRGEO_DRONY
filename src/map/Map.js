...
function Map() {
    ...
    useEffect(() => {
        ...
        const getData = () => {
            axios
                .get(`http://localhost:8088/geoserver/ne/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ne%3Abudynki&outputFormat=application%2Fjson`) // tutaj uważać na link
                .then(
                    (dane) => {
            ...
            >
                ...
                <LayersControl position="topright">
                    ...
                    <LayersControl.BaseLayer name='Countries WMS' >
                        <WMSTileLayer
                            layers='countries'
                            url="http://localhost:8088/geoserver/ne/wms?" // tutaj uważać na link
                        />
                    </LayersControl.BaseLayer>
